<!-- Client View Modal -->
<div wire:ignore.self data-modal-target="modalEl" id="modalEl" tabindex="-1" class="fixed inset-0 z-50 items-center justify-center hidden w-full h-screen max-h-screen p-2 bg-black/30">
>
...
<div class="mb-4 bg-white border rounded-lg shadow-sm border-slate-200">
  ...
  <div class="flex items-center justify-end px-6 pb-3 rounded-b-2xl bg-slate-50 border-slate-200">
    <div class="flex space-x-2">
      <button type="button" wire:click="editClient" class="inline-flex items-center gap-2 px-3 py-1.5 text-sm font-semibold text-white transition bg-blue-600 rounded-lg shadow hover:bg-blue-700">
        <svg class="w-3 h-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
          <path d="M15.232 5.232l3.536 3.536M9 13l6-6M4 20h7a2 2 0 002-2v-7a2 2 0 00-2-2H4a2 2 0 00-2 2v7a2 2 0 002 2z"></path>
        </svg>
        Edit
      </button>
      <button type="button" wire:click="deleteClient" class="inline-flex items-center gap-2 px-3 py-1.5 text-sm font-semibold text-white transition bg-red-600 rounded-lg shadow hover:bg-red-700">
        <svg class="w-3 h-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
