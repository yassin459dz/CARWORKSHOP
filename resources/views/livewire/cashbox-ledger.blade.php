<div>
            @if(!$unlocked)
            <form autocomplete="off" wire:submit.prevent="unlock"
                ...
                <!-- Real password field -->
                <input id="cashbox-password" name="cashbox-pass" type="password" wire:model.defer="enteredPassword"
                    onfocus="this.removeAttribute('readonly');" autocomplete="one-time-code"
                    class="w-full px-3 py-2 mb-2 border rounded" placeholder="Password" autocomplete="false" />
    ...
    <div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full min-w-full text-sm text-gray-700">
                        <thead class="border-b-2 border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
                            <tr>
                                <th class="w-12 px-3 py-4 font-semibold text-center text-gray-800">Status</th>
                                ...
                                <tr class="border-t {{ $rowColor }} transition-all duration-300 hover:shadow-md text-center">
                                    ...
                                    <td class="px-1 py-2">
                                        <div class="flex flex-col items-center">
                                            <span
                                                class="px-2 py-1 text-sm font-bold text-gray-800 rounded-md ring-1 ring-inset ring-gray-600/10 bg-gray-50">
                                                {{ \Carbon\Carbon::parse($data['created_at'])->format('d/m/Y') }}
                                            </span>
                                            <span
                                                class="px-2 py-1 text-xs font-bold text-gray-800 rounded-md ring-1 ring-inset ring-gray-600/10 bg-gray-50">
                                    ...
                                    <td class="px-1 py-2">
                                        <span
                                            class="inline-flex items-center justify-center px-2 py-1 text-base font-bold text-gray-800 rounded-md ring-1 ring-inset ring-gray-600/10 bg-blue-50">
                                    ...
                                    <td class="px-1 py-2">
                                        <span
                                            class="inline-flex items-center justify-center px-2 py-1 text-base font-bold text-blue-800 rounded-md ring-1 ring-blue-600/10 bg-blue-50">
                                    ...
                                    <td class="px-1 py-2">
                                        <span
                                            class="inline-flex items-center justify-center px-2 py-1 text-base font-bold text-green-800 rounded-md ring-1 ring-green-600/10 bg-green-50">
                                    ...
                                    <td class="px-1 py-2">
                                        <span
                                            class="inline-flex items-center justify-center px-2 py-1 text-base font-bold text-red-800 rounded-md ring-1 ring-red-600/10 bg-red-50">
                                    ...
                                    <td class="px-1 py-2">
                                        ...
                                        @endphp
                                        <span
                                            class="inline-flex justify-center items-center rounded-md text-base font-bold ring-1 ring-inset px-2 py-1 whitespace-nowrap {{ $decalageColor }}">
            ...
            @if($selectedDate)
                <div class="fixed inset-0 z-50 flex items-center justify-center bg-opacity-60 backdrop-blur-sm">
                    <div
                        class="w-11/12 md:w-4/5 lg:w-3/4 max-w-4xl bg-white rounded-xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden">
                        <!-- Header - Always visible -->
                        <!-- Header - Always visible -->
                        <div
                            class="sticky top-0 z-10 flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gray-50">
                            <!-- Left side with navigation and date display -->
                            <div class="flex items-center space-x-2">
                                <!-- Previous button -->
                                <button wire:click="goPrevious" @if(!$this->previousDate()) disabled @endif
                                    class="p-2 rounded-full hover:bg-gray-100 disabled:opacity-50" title="Previous day">
                                ...
                                <h3 class="flex items-center text-xl font-semibold text-gray-800 gap-x-2">
                                    ...
                                    <span>Details of: <span
                                            class="text-blue-600">{{ \Carbon\Carbon::parse($selectedDate)->format('d/m/Y') }}</span></span>
                                </h3>

                                <!-- Next button -->
                                <button wire:click="goNext" @if(!$this->nextDate()) disabled @endif
                                    class="p-2 rounded-full hover:bg-gray-100 disabled:opacity-50" title="Next day">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-600" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M9 5l7 7-7 7" />
                            ...
                            <button wire:click="$set('selectedDate', null)"
                                class="p-2 text-gray-400 transition-all duration-200 bg-transparent rounded-full hover:text-red-500 hover:bg-gray-100">
                            ...
                            <div class="flex items-center px-4 py-3 mb-6 border border-blue-100 rounded-lg bg-blue-50">
                                ...
                                <div class="flex items-baseline space-x-2">
                                    ...
                                    <p class="text-2xl font-bold text-blue-800">
                                        {{ number_format($dailyBalances[$selectedDate]['start'], 2, ',', ' ') }} DA</p>
                                </div>
                            </div>
                                    ...
                                    <div class="overflow-x-auto">
                                        <table class="w-full text-gray-700">
                                            ...
                                            <tbody>
                                                @forelse($facturesOfDay as $facture)
                                                    <tr class="border-t border-gray-200 hover:bg-gray-50">
                                                        ...
                                                        <td class="px-4 py-3 text-center">
                                                            <span
                                                                class="inline-flex items-center justify-center gap-x-1 rounded-md text-base font-medium ring-1 ring-inset ring-blue-600/10 px-2 py-1 min-w-[1.5rem] bg-blue-50 text-blue-600 whitespace-nowrap">
                                                                {{ $facture->client->name }}
                                                            </span>
                                                        </td>
                                                        <td class="px-4 py-3 text-center">
                                                            <span
                                                                class="inline-flex items-center justify-center gap-x-1 rounded-md text-base font-medium ring-1 ring-inset ring-yellow-600/10 px-2 py-1 min-w-[1.5rem] bg-yellow-50 text-yellow-600 whitespace-nowrap">
                                                                {{ $facture->car->model }}
                                                            </span>
                                                        </td>
                                                        <td class="px-4 py-3 text-center">
                                                        ...
                                                        <td class="px-4 py-3 text-center">
                                                            <span
                                                                class="inline-flex items-center justify-center gap-x-1 rounded-md text-base font-medium ring-1 ring-inset ring-green-600/10 px-2 py-1 min-w-[1.5rem] bg-green-50 text-green-600 whitespace-nowrap">
                                                ...
                                                @empty
                                                    <tr>
                                                        <td colspan="4" class="px-4 py-6 italic text-center text-gray-500">No
                                                            invoices for this date</td>
                                                    </tr>
                                                @endforelse
                                            </tbody>
                                            <tfoot class="bg-gray-50">
                                                <tr class="font-medium">
                                                    <td colspan="3" class="px-4 py-3 text-lg text-right border-t">TOTAL OF :
                                                    </td>
                                                    <td class="px-4 py-3 text-center">
                                                        <span
                                                            class="inline-flex items-center justify-center gap-x-1 rounded-md text-lg font-medium ring-1 ring-inset ring-blue-600/30 px-2 py-1 min-w-[1.5rem] bg-blue-50 text-blue-800 whitespace-nowrap">
                                                            {{ number_format($inflow, 2, ',', ' ') }} DA
                                                        </span>
                                                    </td>
                                                    <td class="px-4 py-3 text-center">
                                                        <span
                                                            class="inline-flex items-center justify-center gap-x-1 rounded-md text-lg font-medium ring-1 ring-inset ring-green-600/30 px-2 py-1 min-w-[1.5rem] bg-green-50 text-green-800 whitespace-nowrap">
                                                            {{ number_format($facturesOfDay->sum('paid_value'), 2, ',', ' ') }}
                                                            DA
                                                        </span>
                                                    </td>
                                                </tr>
                                            ...
                                            <tbody>
                                                @forelse($mouvementsOfDay as $mvt)
                                                    <tr class="border-t border-gray-200 hover:bg-gray-50">
                                                        ...
                                                        <td class="px-4 py-3 text-center text-gray-800">
                                                            <span
                                                                class=" inline-block max-w-[20ch] truncate items-center justify-center gap-x-1 rounded-md text-base font-medium ring-1 ring-inset ring-yellow-600/10 px-2 py-1 min-w-[1.5rem] bg-yellow-50 text-yellow-600 whitespace-nowrap">
                                                                {{ $mvt->description }}
                                                            </span>
                                                        </td>
                                                        <td class="px-4 py-3 text-center text-gray-800">
                                                            <span
                                                                class="inline-flex items-center justify-center gap-x-1 rounded-md text-base font-medium ring-1 ring-inset ring-red-600/10 px-2 py-1 min-w-[1.5rem] bg-red-50 text-red-600 whitespace-nowrap">
                                                ...
                                                @empty
                                                    <tr>
                                                        <td colspan="3" class="px-4 py-6 italic text-center text-gray-500">No cash
                                                            movements for this date</td>
                                                    </tr>
                                                @endforelse
                                            </tbody>
                                            <tfoot class="bg-gray-50">
                                                <tr class="font-medium">
                                                    <td colspan="2" class="px-4 py-3 text-lg text-right border-t">TOTAL CASH
                                                        OUT:</td>
                                                    <td class="px-4 py-3 text-center">
                                                        <span
                                                            class="inline-flex items-center justify-center gap-x-1 rounded-md text-lg font-medium ring-1 ring-inset ring-red-600/30 px-2 py-1 min-w-[1.5rem] bg-red-50 text-red-800 whitespace-nowrap">
                                                            {{ number_format(collect($mouvementsOfDay)->sum('montant'), 2, ',', ' ') }}
                                                            DA
                                                        </span>
                                                    </td>
                                                </tr>
                            ...
                            <div class="mb-6 overflow-hidden border border-gray-200 rounded-lg shadow-sm bg-gray-50">
                                ...
                                <div class="divide-y divide-gray-200">
                                    <div class="flex items-center justify-between px-4 py-3">
                                        ...
                                        <span
                                            class="inline-flex items-center justify-center gap-x-1 rounded-md text-base font-bold ring-1 ring-inset ring-blue-600/10 px-2 py-1 min-w-[1.5rem] bg-blue-50 text-blue-800 whitespace-nowrap">
                                    ...
                                    <div class="flex items-center justify-between px-4 py-3">
                                        ...
                                        <span
                                            class="inline-flex items-center justify-center gap-x-1 rounded-md text-base font-bold ring-1 ring-inset ring-green-600/10 px-2 py-1 min-w-[1.5rem] bg-green-50 text-green-600 whitespace-nowrap">
                                            + {{ number_format($facturesOfDay->sum('paid_value'), 2, ',', ' ') }} DA </span>
                                    </div>
                                    <div class="flex items-center justify-between px-4 py-3">
                                        <span class="font-semibold text-gray-700">Total Cash Out</span>
                                        <span
                                            class="inline-flex items-center justify-center gap-x-1 rounded-md text-base font-bold ring-1 ring-inset ring-red-600/10 px-2 py-1 min-w-[1.5rem] bg-red-50 text-red-800 whitespace-nowrap">
                                            - {{ number_format(collect($mouvementsOfDay)->sum('montant'), 2, ',', ' ') }}
                                            DA</span>
                                    </div>
                                    <div class="flex items-center justify-between px-4 py-3 bg-gray-50">
                                        ...
                                        <span
                                            class="text-lg inline-flex items-center justify-center gap-x-1 rounded-md  font-bold ring-1 ring-inset ring-green-600/10 px-2 py-1 min-w-[1.5rem] bg-green-50 text-green-800 whitespace-nowrap">
                                            {{ number_format($dailyBalances[$selectedDate]['start'] + $facturesOfDay->sum('paid_value') - collect($mouvementsOfDay)->sum('montant'), 2, ',', ' ') }}
                                            DA</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    percent() { return Math.min(Math.abs(this.decalage / (this.total || 1) * 100), 100) }
                                ...
                                <div class="p-5">
                                    ...
                                    + ' DA'">
                                            ...
                                            <p class="mt-1.5 text-xs text-gray-500">Calculated from start value, cash in, and
                                                cash out</p>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="relative rounded-md shadow-sm">
                                                ...
                                                <div
                                                    ...
                                                    <span
                                                        class="px-2 py-1 text-2xl font-bold text-blue-800 bg-blue-100 rounded-md">DA</span>
                                                </div>
                                                <input id="actual-cash-count"
                                                    ...
                                                    type="number" step="100" x-model.number="actual"
                                                    @input.debounce.300ms="$wire.updateDecalage(actual)" />
                                            </div>
                                            <p class="mt-1.5 text-xs text-gray-500">Enter the exact amount you count in the cash
                                                box</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-4 mt-6 border border-gray-200 rounded-lg md:col-span-2 bg-gray-50">
                                        <div>
                                            <div class="flex items-center justify-between">
                                                <div class="max-w-xs">
                                                    <h5 class="text-base font-semibold text-gray-800">Discrepancy (Décalage)
                                                    </h5>
                                                    <p class="text-xs text-gray-500">Difference between expected and actual cash
                                                    </p>
                                                </div>
                                                <div>
                                                    <span
                                            ...
                                            <div class="flex items-center mt-4">
                                                <div class="w-full h-3 overflow-hidden bg-gray-200 rounded-full">
                                                    <div class="h-3 transition-all duration-300 ease-in-out rounded-full"
                                            ...
                                            <p class="mt-2 text-sm font-medium"
                                                :class="decalage < 0 ? 'text-red-600' : 'text-green-600'" x-text="(decalage >= 0 ? '+' : '') +
                                    (decalage / total * 100).toFixed(2) + '%'"></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-6">
                                        ...
                                        <div class="relative rounded-md shadow-sm">
                                            ...
                                            <input id="next-day-balance"
                                                ...
                                                type="number" step="100" wire:model.defer="nextStartValue" />
                                        </div>
                                ...
                                <div class="flex justify-end px-6 py-4 border-t border-gray-200 bg-gray-50">
                                    <button @click.prevent="$wire.saveEndValue()"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="w-5 h-5 text-white transition duration-200 group-hover:scale-110" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M5 13l4 4L19 7" />
                                        </svg>
                        ...
                        @if($showEndModal)
                            <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                                <div class="w-full max-w-md p-6 bg-white rounded-lg shadow-xl">
                                    <h3 class="mb-4 text-lg font-bold">Edit End Value –
                                        {{ \Carbon\Carbon::parse($endEditDate)->format('d/m/Y') }}</h3>
                                    <div class="space-y-4">
                                        <div>
                                            <label class="block mb-1 font-semibold">End ssValue (DA)</label>
                                            <input type="number" inputmode="numeric" pattern="[0-9]*" step="0.01"
                                                wire:model.defer="endValue" class="w-full px-4 py-2 border rounded-md" />
                                        </div>
