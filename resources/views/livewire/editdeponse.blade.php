<div class="max-w-md p-6 mx-auto mt-8 bg-white shadow-lg rounded-2xl">
    <h2 class="mb-4 text-2xl font-semibold text-gray-800">EDIT CASH OUT</h2>


    {{-- Montant --}}
    <div class="mb-4">
        <label for="montant" class="block mb-1 text-sm font-medium text-gray-700">VALUE</label>
        <input
    ...
    <button
        ...
        class="w-full px-5 py-2 font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 disabled:opacity-50"
    >
        <span wire:loading>UPDATE</span>
    </button>
